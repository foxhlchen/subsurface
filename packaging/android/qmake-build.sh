...
## here something complete wonky happens. The qrc_kirigami.cpp file doesn't get created. What the heck?
#$QT5_ANDROID/android/bin/rcc "$SUBSURFACE_SOURCE"/mobile-widgets/3rdparty/kirigami/kirigami.qrc > qrc_kirigami.cpp
